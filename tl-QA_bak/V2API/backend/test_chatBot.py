...
testData = [
    ...
    ('lack of necessary params', 'liveController1_token', 'liveController1_nonce', True, False, [], 4),
...
class TestEditBot():
    ...
    def testEdit(self, scenario, token, nonce, isAuto, isRush, targetList, expected):
        ...
        if scenario == 'lack of necessary params':
            del body['autoChatBotSwitch']
            del body['rushChatBotSwitch']
