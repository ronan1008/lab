...
if __name__ == "__main__":
    ...
    async def voiceroom_send_nonZero_backpackGift():
        ...
        voiceClient = VoiceRoomClient(domain, 'track0050', '123456')
        await voiceClient.goto_room(voiceRoom_id)
        await voiceClient.send_event('gift', {"giftId": '7997b081-1f5a-4ba7-baa4-7e175d56b05c', "targetUserId": voiceMaster.identity, "count": 1, "backpackId": 9788 })
        await voiceClient.recv_events(None, 2)
        await voiceClient.leaveRoom()
        await voiceMaster.leaveRoom()
    ...
    async def voiceroom_master_pullOn_phonePosition():
        domain = 'testing-api.xtars.com'
        voiceRoom_id = 5
        voiceMaster = VoiceRoomMaster(domain, 'broadcaster021', '123456')
        await voiceMaster.goto_room(voiceRoom_id)
        ...
        voiceClient1 = VoiceRoomClient(domain, 'broadcaster001', '123456')
        await voiceClient1.goto_room(voiceRoom_id)
        await voiceClient1.recv_events()


        voiceClient2 = VoiceRoomClient(domain, 'track0060', '123456')
        await voiceClient2.goto_room(voiceRoom_id)
        await voiceClient2.recv_events()

        #觀眾預約上麥
        await voiceClient1.send_event(event='book_seat', payload={})
        await voiceClient1.recv_events('seat_booked')

        await voiceClient2.send_event(event='book_seat', payload={})
        await voiceClient2.recv_events('seat_booked')
        #master將觀眾拉上麥位
        await voiceMaster.send_event('pickup_seat', {"targetUserId": voiceClient1.identity, "seatType": "host", "seatIndex": 1})
        await voiceMaster.recv_events('seat_pickedup')

        await voiceMaster.send_event('pickup_seat', {"targetUserId": voiceClient2.identity, "seatType": "host", "seatIndex": 2})
        await voiceMaster.recv_events('seat_pickedup')

        await asyncio.sleep(200)
        await voiceClient1.leaveRoom()
        await voiceClient2.leaveRoom()
        await voiceMaster.leaveRoom()
    ...
    # print(f"( voiceroom : 聲聊間 聲聊將觀眾拉上麥位)")
    # asyncio.run(voiceroom_master_pullOn_phonePosition())
